...
switch ($_GET['type']) {
    ...
    case 'edit':
        ...
        fclose($file);
        $content = ['<textarea class="text" name="file_content"  placeholder="Enter your code here..." id="file_content" rows="50" style="width: 100%;resize: vertical;">' . $file_content . '</textarea>'];
