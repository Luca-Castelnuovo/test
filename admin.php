...
if (isset($_SESSION['invite_response'])) {
    ...
    $type = 'default';
    $content = ["<a class='dropdown-trigger btn' href='#' id='submit'>Generate Invite Code</a><a class='dropdown-trigger btn' href='?users'>Users</a><a class='dropdown-trigger btn' href='?login_log'>Login Log</a><br><br><a href='/home'>Back</a>"];
    $back_button = false;
    $title = 'Admin Panel';
}
