...
$('#submit').click(function () {
    ...
    var data = 'CSRFtoken=' + CSRFtoken.val() + '&type=files' + '&file_type=' + file_type.val() + '&project_id=' + project_id.val() + '&file_id=' + file_id.val() +'&file_name=' + file_name.val() + '&file_lang=' + file_lang.val() + '&file_content=' + file_content.text() + '&file_delete=' + file_delete.val();
    console.log(data);
