...
case 'delete':
    ...
    $content = ['<input placeholder="To confirm type `delete` if you type anything else your project wont be deleted" type="text" name="project_delete" autocomplete="off" class="text" autofocus> <i class="fa fa-trash"></i>'];
    $button_text = 'Submit';
    break;
