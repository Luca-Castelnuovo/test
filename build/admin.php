...
if (isset($_SESSION['invite_response'])) {
    $type = 'code_response';
    $content = ["<textarea rows='10' cols='50' readonly>https://test.lucacastelnuovo.nl/register/{$_SESSION['invite_response']}</textarea>"];
    ...
    $type = 'default';
    $content = ["<a class='dropdown-trigger btn' href='?users'>Users</a><a class='dropdown-trigger btn' href='?login_log'>Login Log</a><a class='dropdown-trigger btn' href='#' id='submit'>Code</a><br><br><a class='dropdown-trigger btn' href='/home'>Back</a>"];
    $back_button = false;
    $title = 'Admin Panel';
}
